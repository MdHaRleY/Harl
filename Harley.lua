...
Id_Sudo = Sudo
List_Sudos = {Id_Sudo,1211984724,903016588,924081763}
print("\27[34m"..[[
...
var = "مطور السورس"
elseif tonumber(user_id)  == tonumber(903016588) then
var = "المطور اساسي"
...
Reply_Status(msg,msg.sender_user_id_,"lockkick","💢️┇تم قفـل الرواب��")  
return false
end 
...
if result.sender_user_id_ == tonumber(1211984724) then
...
if text == 'تفعيل الايدي بالصوره' and Constructor(msg) then   
database:del(bot_id..'Tshake:Lock:ID:Bot:Photo'..msg.chat_id_) 
send(msg.chat_id_, msg.id_,'☑┇تم تفعيل الايدي بالصوره') 
end
if text == 'تعطيل الايدي بالصوره' and Constructor(msg) then  
