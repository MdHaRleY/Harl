...
if text == (database:get(bot_id.."Tshake:Name:Bot") or "هارل") then
Namebot = (database:get(bot_id.."Tshake:Name:Bot") or "هارل")
local namebot = {
...
local Name_Bot = (database:get(bot_id.."Tshake:Name:Bot") or "هارل")
